---
title: "Analisando distribuição de dados com histograma no R"
...
Vídeo tema para este post em [Como analisar distribuição em dados - histograma curva normal](https://youtu.be/YLrmz43Ib1M){target="_blank"}
:::
