...
### {{< fa 1 >}} [**O que é este exercício **]{style="color: #5AC8BE ;"}
...
Para reproduzir os códigos abaixo serão necessários os pacotes [tidyverse](https://www.tidyverse.org/){target="_blank"}, 
[sjplot](https://github.com/strengejacke/sjPlot/){target="_blank"}, [gt](https://github.com/rstudio/gt){target="_blank"},
[gtExtras](https://github.com/jthomasmock/gtExtras){target="_blank"} e [funModeling]([gt](https://github.com/rstudio/gt){target="_blank"}{target="_blank"}

**Dados**

O conjunto de dados é o gapminder disponível no pacote [gapminder](https://www.rdocumentation.org/packages/gapminder/versions/0.3.0){target="_blank"} , no R podendo ser acessado via código `install.package("gapminder)`  
