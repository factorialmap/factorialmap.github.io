...
Para reproduzir os códigos abaixo serão necessários os pacotes [tidyverse](https://www.tidyverse.org/){target="_blank"}, [sjplot](https://github.com/strengejacke/sjPlot/){target="_blank"}, [gt](https://github.com/rstudio/gt){target="_blank"}, [gtExtras](https://github.com/jthomasmock/gtExtras){target="_blank"}, e  [funModeling](https://github.com/pablo14/funModeling){target="_blank"}
