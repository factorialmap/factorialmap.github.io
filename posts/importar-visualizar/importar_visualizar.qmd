...
-   É a etapa de extração de dados que possam contribuir para a solução do problema a ser resolvido.
...
-   Geralmente estão atrelados a uma métrica de sucesso e é feito após a etapa **P** do **PDCA** , **PPDAC** ou outro método de análise de fenõmeno e causa raíz utilizado.
    ...
    ![Processo de projeto kaizen](data_import.png){width="700"}
...
**Vamos juntar as variáveis e analisar sob outro ponto de vista**
...
**Sera que o tamanho da familia importa e está bem representada ?**
...
**Será que o título dos nomes importa ?**
...
### [**Video**]{style="color: #5AC8BE ;"}

-   [Video no YouTube sobre o tema](https://youtu.be/p-wiv5wnLMw)
