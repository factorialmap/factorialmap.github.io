...
### [**O que é uma matriz de confusão**]{style="color: #5AC8BE ;"}
...
Para reproduzir os códigos abaixo serão necessários os pacotes [tidyverse](https://www.tidyverse.org/) , [tidymodels](https://www.tidymodels.org/) e [janitor](https://github.com/sfirke/janitor)\
O principal pacote que será usando para analisar uma matriz de confusão é o pacote [yardstick](https://yardstick.tidymodels.org/) que já é carregado quando chamamos o pacote **tidymodels**.
